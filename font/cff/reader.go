...
func (r *reader) sid() (int, error)     { return r.card16() }
func (r *reader) offsize() (int, error) { return r.card8() }
...
func (r *reader) strindex() (results strtable, err error) {
	idx, err := r.index()
	if err != nil {
		return nil, err
	}
...
func (r *reader) table() (results table, err error) {
	idx, err := r.index()
	if err != nil {
		return nil, err
	}
